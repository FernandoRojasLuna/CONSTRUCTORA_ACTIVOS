...
export default function SedesEdit({ sede }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        tipo: sede.tipo || 'proyecto',
        activo: sede.activo ?? true,
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('sedes.update', sede.id));
    };

    return (
        <AppLayout>
            <Head title={`Editar ${sede.nombre}`} />
            ...
            <div className="mb-6">
                ...
                <h1 className="text-2xl font-bold text-gray-900">Editar Sede</h1>
                <p className="mt-1 text-sm text-gray-500">
                    Modifica la información de {sede.nombre}
                </p>
            </div>
                        ...
                        <Card>
                            ...
                            <Card.Footer>
                                ...
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Guardando...' : 'Actualizar Sede'}
                                </Button>
                            </Card.Footer>
                        </Card>
                    </div>
